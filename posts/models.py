...
class Comment(models.Model):
    ...
    created_at      = models.DateTimeField(default=timezone.now)
    update_at       = models.DateTimeField(auto_now=True)
    likes           = models.ManyToManyField(Users, related_name='liked_comments', default=None, blank=True)
...
class Reply(models.Model):
    author          = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='replies', blank=True, null=True)
    comment         = models.ForeignKey(Comment, on_delete=models.CASCADE, related_name='replies', blank=True, null=True)
    content         = models.TextField()
    created_at      = models.DateTimeField(default=timezone.now)
    update_at       = models.DateTimeField(auto_now=True)
    likes           = models.ManyToManyField(Users, related_name='liked_replies', default=None, blank=True)
